                ...
                <div class="widget">
                    ...
                    <div class="widget-body padding-none">
                        <div class="innerAll inner-2x border-bottom">
                            ...
                            <!-- Events list END -->
                            <div class="checkbox margin-bottom-none">
                                <label for="drop-remove" class="checkbox-custom">
                        ...
                        <p class="margin-none innerAll inner-2x bg-gray">SMART provides a full-sized, drag &amp; drop calendar. It uses AJAX to fetch events on-the-fly for each month and is easily configured to use your own feed format, plus there's an extension provided for Google Calendar.</p>
                    </div>
                </div>
                <!-- // Widget END -->
                <!-- Widget -->

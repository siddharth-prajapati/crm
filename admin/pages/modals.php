...
<div class="innerLR">
    <div class="widget">
        <div class="widget-head">
            <h4 class="heading">
                Account <span>Modal Examples</span>
            </h4>
        </div>
    ...
    <div class="widget">
        <div class="widget-head">
            <h4 class="heading">
                Form Wizards <span>Modal Examples</span>
            </h4>
        </div>
        <div class="widget-body">
            <!-- Form Modal 2 -->
            ...
            <!-- // Modal END -->
            <!-- Form Modal 3 -->
            <a href="#modal-3" data-toggle="modal" class="btn btn-inverse"><i class="fa fa-fw fa-magic"></i> Modal Wizard Example 2</a>
            <!-- Modal -->
    ...
    <div class="widget">
        <div class="widget-head">
            <h4 class="heading">
                Email <span>Modal Examples</span>
            </h4>
        </div>
        <div class="widget-body">
            <!-- Form Modal 1 -->
...
<div class="widget">
    <div class="widget-head">
        <h4 class="heading">
            Other <span>Modal Examples</span>
        </h4>
    </div>
    <div class="widget-body">
        <!-- Form Modal 1 -->
...
<div class="widget">
    <div class="widget-head">
        <h4 class="heading">
            Bootbox <span>Manage modals with JavaScript API</span>
        </h4>
    </div>
    <div class="widget-body">
...
<a href="#" class="btn btn-default">Just a button</a> <a href="#modal-simple" data-toggle="modal" class="btn btn-primary">Open Live Modal</a>
</div>
            <!-- // Modal footer END -->
        </div>
    </div>
...
<div class="modal fade" id="modal-simple">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <!-- Modal footer -->
            <div class="modal-footer">
<a href="#" class="btn btn-default" data-dismiss="modal">Close</a> <a href="#" data-dismiss="modal" class="btn btn-primary">Save changes</a>
</div>
            <!-- // Modal footer END -->
        </div>
    </div>

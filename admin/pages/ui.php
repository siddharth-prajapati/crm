<div class="innerLR">
    <h1>
        User Interface Elements <span>Buttons, alerts, pagination, ribbons & more.</span>
    </h1>
...
Dropdown Default <span class="caret"></span>
</button>
...
Dropdown Primary <span class="caret"></span>
</button>
...
Dropdown Inverse <span class="caret"></span>
</button>
                <ul class="dropdown-menu pull-right">
                    <li><a href="#">Action</a></li>
                    <li><a href="#">Another action</a></li>
...
Dropdown Danger <span class="caret"></span>
</button>
                <ul class="dropdown-menu pull-right">
                    <li><a href="#">Action</a></li>
                    <li><a href="#">Another action</a></li>
...
Dropdown Success <span class="caret"></span>
</button>
                <ul class="dropdown-menu pull-right">
                    <li><a href="#">Action</a></li>
                    <li><a href="#">Another action</a></li>
...
Dropdown Warning <span class="caret"></span>
</button>
                <ul class="dropdown-menu pull-right">
                    <li><a href="#">Action</a></li>
                    <li><a href="#">Another action</a></li>
        ...
        <div class="innerAll">
            ...
            <button class="btn btn-default btn-icon-stacked">
            ...
            <button class="btn btn-danger btn-icon-stacked">
                <i class="fa fa-2x fa-facebook"></i> 
                <span>
                    Join using your
                    <br/>
            ...
            <button class="btn btn-success btn-icon-stacked">
                <i class="fa fa-2x fa-facebook"></i> 
                <span>
                    Join using your
                    <br/>
            ...
            <button class="btn btn-warning btn-icon-stacked">
                <i class="fa fa-2x fa-facebook"></i> 
                <span>
                    Join using your
                    <br/>
        ...
        <div class="innerAll">
            ...
            <button class="btn btn-stroke btn-primary btn-icon-stacked">
                <i class="fa fa-2x fa-twitter"></i> 
                <span>
                    Join using your
                    <br/>
            ...
            <button class="btn btn-stroke btn-inverse btn-icon-stacked">
                <i class="fa fa-2x fa-google-plus"></i> 
                <span>
                    Join using your
                    <br/>
            ...
            <button class="btn btn-stroke btn-danger btn-icon-stacked">
                <i class="fa fa-2x fa-facebook"></i> 
                <span>
                    Join using your
                    <br/>
            ...
            <button class="btn btn-stroke btn-success btn-icon-stacked">
                <i class="fa fa-2x fa-facebook"></i> 
                <span>
                    Join using your
                    <br/>
            ...
            <button class="btn btn-stroke btn-warning btn-icon-stacked">
                <i class="fa fa-2x fa-facebook"></i> 
                <span>
                    Join using your
                    <br/>
    ...
    <div class="widget widget-heading-simple widget-body-gray">
        ...
        <div class="widget-head">
            <h4 class="heading glyphicons warning_sign">
                <i></i>Alerts
            </h4>
        </div>
        <!-- // Widget Heading END -->
...
too good.
    ...
    <div class="widget widget-heading-simple widget-body-gray">
        ...
        <div class="widget-body" data-toggle="source-code" data-placement="outside">
            <div class="pagination-right margin-none">
                <ul class="pagination pagination-right margin-none">
                    <li class="disabled"><a href="#">&laquo;</a></li>
                    <li class="active"><a href="#">1</a></li>
                    <li><a href="#">2</a></li>
                    <li><a href="#">3</a></li>
    ...
    <div class="widget widget-heading-simple widget-body-white">
        <div class="widget-head">
            <h3 class="heading glyphicons show_thumbnails">
                <i></i>JQuery Pagination (Dynamic / AJAX Pagination)
            </h3>
        </div>
        <div class="widget-body">
            <div class="alert alert-primary">Init with 23 pages. Visible only 10 at once. Start with page 1.</div>
            <p class="jquery-bootpag-content">Dynamic content here.</p>
            <p class="jquery-bootpag-pagination"></p>
        </div>
    </div>
...
<span class="badge badge-stroke">1</span>
                ...
                <td>
<span class="label label-default">Default</span> <span class="label label-default label-stroke">Default Stroke</span>
</td>
            </tr>
            <tr>
                <td>Primary</td>
...
<span class="label label-inverse label-stroke">Inverse Stroke</span>
    ...
    <div class="widget widget-heading-simple widget-body-white">
        <div class="widget-head">
            <h4 class="heading glyphicons show_thumbnails">
                <i></i>Progress bars
            </h4>
        </div>
        <div class="widget-body">

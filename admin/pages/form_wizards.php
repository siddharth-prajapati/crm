    ...
    <div class="wizard">
        <div class="widget widget-tabs widget-tabs-double widget-tabs-vertical row row-merge">
            ...
            <div class="widget-head col-md-3">
                <ul>
                    <li class="active">
                        <a href="#tab1-4" class="glyphicons user" data-toggle="tab">
<i></i>
<span class="strong">Step 1</span>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="tab1-4">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <label>Title</label>
                                <input type="text" class="inputTitle col-md-6 form-control" value="" placeholder="Enter product title ..." />
    ...
    <div class="wizard">
        <div class="widget widget-tabs widget-tabs-responsive">
            ...
            <div class="widget-head">
                <ul>
                    <li class="active">
                        <a href="#tab1-1" class="glyphicons home" data-toggle="tab"><i></i>First</a>
                    </li>
                    <li>
                        <a href="#tab2-1" class="glyphicons umbrella" data-toggle="tab"><i></i>Second</a>
                    </li>
                    <li>
                        <a href="#tab3-1" class="glyphicons fishes" data-toggle="tab"><i></i>Third</a>
                    </li>
                    <li>
                        <a href="#tab4-1" class="glyphicons car" data-toggle="tab"><i></i>Fourth</a>
                    </li>
                    <li>
                        <a href="#tab5-1" class="glyphicons leaf" data-toggle="tab"><i></i>Fifth</a>
                    </li>
                    <li>
                        <a href="#tab6-1" class="glyphicons cup" data-toggle="tab"><i></i>Sixth</a>
                    </li>
                    <li>
                        <a href="#tab7-1" class="glyphicons tie" data-toggle="tab"><i></i>Seventh</a>
                    </li>
                </ul>
            </div>
            <!-- // Widget heading END -->
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane" id="tab2-1">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <label>Description</label>
                                <textarea id="textDescription_2" class="wysihtml5 form-control" style="width: 96%;" rows="5">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu, pretium quis, sem. Nulla consequat massa quis enim. Donec pede justo, fringilla vel, aliquet nec, vulputate eget, arcu. In enim justo, rhoncus ut, imperdiet a, venenatis vitae, justo. Nullam dictum felis eu pede mollis pretium.</textarea>
                            </div>
                        </div>
                    </div>
                    <!-- // Step 2 END -->
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane" id="tab2-2">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <label>Description</label>
                                <textarea id="textDescription_3" class="wysihtml5 form-control" style="width: 96%;" rows="5">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu, pretium quis, sem. Nulla consequat massa quis enim. Donec pede justo, fringilla vel, aliquet nec, vulputate eget, arcu. In enim justo, rhoncus ut, imperdiet a, venenatis vitae, justo. Nullam dictum felis eu pede mollis pretium.</textarea>
                            </div>
                        </div>
                    </div>
                    <!-- // Step 2 END -->
    ...
    <div class="wizard">
        <div class="widget widget-tabs widget-wizard-pills widget-tabs-responsive">
            ...
            <div class="widget-head">
                <ul>
                    <li class="status">
                        <span class="r">Step <span class="step-current">2</span> of <span class="steps-total">5</span></span>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane" id="tab2-3">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <label>Description</label>
                                <textarea id="textDescription_4" class="wysihtml5 form-control" style="width: 96%;" rows="5">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu, pretium quis, sem. Nulla consequat massa quis enim. Donec pede justo, fringilla vel, aliquet nec, vulputate eget, arcu. In enim justo, rhoncus ut, imperdiet a, venenatis vitae, justo. Nullam dictum felis eu pede mollis pretium.</textarea>
                            </div>
                        </div>
                    </div>
                    <!-- // Step 2 END -->

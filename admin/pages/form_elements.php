...
<div class="innerLR">
	...
	<div class="widget widget-heading-simple widget-body-gray">
		<div class="widget-body">
			<p>There are various form elements contained in SMART, custom select controls, custom checkbox &amp; radio controls, custom input controls with &amp; without appended / prepended elements (icons, dropdowns, dropups, groups), toggle (on/off) buttons, icons &amp; many more.</p>
		</div>
	</div>
	<!-- // Widget END -->
	...
	<div class="row">
		...
		<div class="col-md-6">
			...
			<div class="widget widget-heading-simple widget-body-white" >
				...
				<div class="widget-body"><input type="text" placeholder="Text input" class="form-control" />
</div>
		...
		<div class="widget-body">
			...
			<div class="row">
				<div class="col-md-4">
					<div class="well">
						<h4>Default input</h4>
						<input class="form-control datepicker1" type="text" value="2013-02-14"  />

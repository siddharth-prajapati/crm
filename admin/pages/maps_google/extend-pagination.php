    ...
    <div class="widget widget-tabs widget-tabs-vertical row row-merge" id="maps_google_tabs">
        ...
        <div class="widget-head bg-gray col-md-3">
            <ul>
                ...
                <li class="active"><a href="?page=maps_google&amp;section=extend-pagination">Extend with pagination</a></li>
        ...
        <div class="widget-body col-md-9">
            ...
            <div class="tab-content innerAll inner-2x">
                ...
                <h4 class="separator bottom">
                    Extend Gmaps with pagination
                </h4>
                <div class="thumbnail">
                    <div class="map_canvas" id="google-map-extend-pagination" style="height: 400px"></div>
                </div>
                <!-- // Pagination END -->
            </div>
            <!-- // Tab content END -->

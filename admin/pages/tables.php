...
<!-- // Table END -->
	...
	<h3 class="innerTB">Show / hide columns</h3>
...
<!-- // Table END -->
	...
	<h3 class="innerTB">Vertical Scrolling</h3>
...
<!-- // Table END -->
	...
	<h3 class="innerTB">Loading large data set with AJAX (5,000 results)</h3>
...
<!-- // Table END -->
	...
	<h3 class="innerTB">Fixed Header and Column Reorder (Drag &amp; Drop)</h3>

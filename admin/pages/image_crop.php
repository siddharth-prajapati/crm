<h1>
    Image Cropping <span>Component</span>
</h1>
<div class="innerLR">
        ...
        <div class="widget-body">
            <div class="row">
                <div class="col-md-6 center">
                    ...
                    <p class="lead separator top">Simple cropping with auto-selection</p>
                </div>
                <div class="col-md-6 center">
                    ...
                    <p class="lead separator top">Image cropping with preview</p>
                </div>
            </div>
        </div>
    </div>

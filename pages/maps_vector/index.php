...
<div class="innerLR">
    <!-- Tabs -->
    <div class="widget widget-tabs widget-tabs-vertical row row-merge" id="maps_vector_tabs">
        <!-- Tabs Heading -->
        <div class="widget-head col-md-3 bg-gray">
            <ul class="border-bottom">
                <li class="active"><a href="#tab2" data-toggle="tab" data-init="1">Markers on the world map</a></li>
                <li><a href="#tab1" data-toggle="tab">GDP by country</a></li>
                ...
                <li>
                    <a href="?page=maps_vector&amp;section=fullscreen"><span class="pull-right label label-primary">new</span> Full screen vector map</a>
                </li>
            </ul>
        </div>
        <!-- // Tabs Heading END -->
        <div class="widget-body col-md-9">
            <div class="tab-content innerAll inner-2x">
                ...
                <div class="tab-pane active" id="tab2">
                    ...
                    <div id="world-map-markers" style="height: 400px; overflow: hidden;"></div>
                </div>
                <!-- // Tab content END -->
                <!-- Tab content -->
...
<span class="jvm-legend-item jvm-legend-item-ump"></span> <span>Nicolas Sarkozy</span> <span class="jvm-legend-item jvm-legend-item-ps"></span> <span>Segolene Royal</span>
</div>
...
<span>Francois Hollande</span> <span class="jvm-legend-item jvm-legend-item-ump"></span> <span>Nicolas Sarkozy</span>
</div>
                </div>
                <!-- // Tab content END -->
                <!-- Tab content -->

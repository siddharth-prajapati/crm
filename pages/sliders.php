        ...
        <div class="col-md-6">
            ...
            <div class="widget widget-heading-simple widget-body-gray">
                ...
                <div class="widget-head">
                    <h4 class="heading glyphicons adjust_alt">
                        <i></i>Basic Range Slider
                    </h4>
                </div>
                <!-- // Widget heading END -->
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="widget widget-heading-simple widget-body-white">
                ...
                <div class="widget-head">
                    <h4 class="heading glyphicons adjust_alt">
                        <i></i>Range Slider without Arrows
                    </h4>
                </div>
                <!-- // Widget heading END -->
                <div class="widget-body">
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="widget widget-heading-simple widget-body-gray">
                ...
                <div class="widget-head">
                    <h4 class="heading glyphicons adjust_alt">
                        <i></i>Range Slider with formatter
                    </h4>
                </div>
                <!-- // Widget heading END -->
                <div class="widget-body">
    ...
    <div class="widget widget-heading-simple widget-body-white">
        ...
        <div class="widget-body">
            ...
            <div class="sliders-vertical">
                <span>77</span> <span>55</span> <span>33</span> <span>40</span> <span>45</span> 

<h3>
    Tabs <span>| in 7 awesome styles</span>
</h3>
<div class="innerLR">
    <!-- Tabs -->
        ...
        <div class="widget widget-tabs widget-tabs-double-2 widget-tabs-responsive">
            ...
            <div class="widget-head">
                <ul>
                    ...
                    <li>
                        <a class="glyphicons credit_card" href="#tabPayments" data-toggle="tab"><i></i><span>Payments</span></a>
                    </li>
                    <li>
                        <a class="glyphicons cogwheel" href="#tabSupport" data-toggle="tab"><i></i><span>Technical Support</span></a>
                    </li>
                    <li>
                        <a class="glyphicons snowflake" href="#tabFeatures" data-toggle="tab"><i></i><span>Features</span></a>
                    </li>
                </ul>
            </div>
            <!-- // Tabs Heading END -->
            ...
            <div class="tabsbar">
                <ul>
                    <li class="glyphicons camera active">
                        <a href="#tab1-3" data-toggle="tab"><i></i> View all photos <strong>(43)</strong></a>
                    </li>
                    <li class="glyphicons folder_open">
                        <a href="#tab2-3" data-toggle="tab"><i></i> Albums <strong>(3)</strong></a>
                    </li>
                    <li class="glyphicons circle_plus tab-stacked">
                        <a href="#tab3-3" data-toggle="tab"><i></i> <span>Add Photos</span></a>
                    </li>
                    <li class="glyphicons folder_plus tab-stacked">
                        <a href="#tab4-3" data-toggle="tab"><i></i> <span>Create Album</span></a>
                    </li>
                </ul>
            </div>
            <!-- // Tabs Heading END -->
            ...
            <div class="tabsbar tabsbar-2">
                <ul class="row row-merge">
                    <li class="col-md-3 glyphicons cargo active">
                        <a href="#tab1-4" data-toggle="tab"><i></i> Product Listing</a>
                    </li>
                    <li class="col-md-3 glyphicons circle_info">
                        <a href="#tab2-4" data-toggle="tab"><i></i> <span>Product Details</span></a>
                    </li>
                    <li class="col-md-3 glyphicons cart_in">
                        <a href="#tab3-4" data-toggle="tab"><i></i> <span>Shopping Cart</span></a>
                    </li>
                    <li class="col-md-3 glyphicons pencil">
                        <a href="#tab4-4" data-toggle="tab"><i></i> <span>Shop Management</span></a>
                    </li>
                </ul>
            </div>
            <!-- // Tabs Heading END -->
    ...
    <div class="relativeWrap" >
        <div class="widget widget-tabs widget-tabs-responsive">
            ...
            <div class="widget-head">
                <ul>
                    <li class="active">
                        <a class="glyphicons coffe_cup" href="#tab-1" data-toggle="tab"><i></i>Active tab</a>
                    </li>
                    <li>
                        <a class="glyphicons share_alt" href="#tab-2" data-toggle="tab"><i></i>Other tab</a>
                    </li>
                </ul>
            </div>
            <!-- // Tabs Heading END -->
    ...
    <div class="relativeWrap" >
        <div class="widget widget-tabs widget-tabs-double widget-tabs-vertical row row-merge">
            ...
            <div class="widget-head col-md-3">
                <ul>
                    <li class="active">
                        <a href="#tab1-1" class="glyphicons user" data-toggle="tab"><i></i><span class="strong">Step 1</span><span>Personal details</span></a>
                    </li>
                    <li>
                        <a href="#tab2-1" class="glyphicons calculator" data-toggle="tab"><i></i><span class="strong">Step 2</span><span>Billing details</span></a>
                    </li>
                    <li>
                        <a href="#tab3-1" class="glyphicons credit_card" data-toggle="tab"><i></i><span class="strong">Step 3</span><span>Payment</span></a>
                    </li>
                    <li>
                        <a href="#tab4-1" class="glyphicons circle_ok" data-toggle="tab"><i></i><span class="strong">Step 4</span><span>Confirmation</span></a>
                    </li>
                </ul>
            </div>
            <!-- // Tabs Heading END -->
    ...
    <div class="relativeWrap" >
        <div class="widget widget-tabs widget-tabs-double widget-tabs-responsive">
            ...
            <div class="widget-head">
                <ul>
                    <li class="active">
                        <a href="#tab1-2" class="glyphicons user" data-toggle="tab"><i></i><span class="strong">Step 1</span><span>Personal details</span></a>
                    </li>
                    <li>
                        <a href="#tab2-2" class="glyphicons calculator" data-toggle="tab"><i></i><span class="strong">Step 2</span><span>Billing details</span></a>
                    </li>
                    <li>
                        <a href="#tab3-2" class="glyphicons credit_card" data-toggle="tab"><i></i><span class="strong">Step 3</span><span>Payment</span></a>
                    </li>
                    <li>
                        <a href="#tab4-2" class="glyphicons circle_ok" data-toggle="tab"><i></i><span class="strong">Step 4</span><span>Confirmation</span></a>
                    </li>
                </ul>
            </div>
            <!-- // Tabs Heading END -->
    ...
    <div class="relativeWrap" >
        <div class="widget widget-4 widget-tabs-icons-only margin-bottom-none">
            ...
            <div class="widget-head">
                <h4 class="heading">
                    Tabs from Icons <span>400+ Premium Icons to choose from</span>
                </h4>
                <!-- Tabs -->
                <ul class="pull-right">
                    <li>Filter by</li>
                    <li class="glyphicons user_add active">
                        <span data-toggle="tab" data-target="#tab1-5"><i></i></span>
                    </li>
                    <li class="glyphicons shopping_cart">
                        <span data-toggle="tab" data-target="#tab2-5"><i></i></span>
                    </li>
                    <li class="glyphicons envelope">
                        <span data-toggle="tab" data-target="#tab3-5"><i></i></span>
                    </li>
                    <li class="glyphicons link">
                        <span data-toggle="tab" data-target="#tab4-5"><i></i></span>
                    </li>
                    <li class="glyphicons camera">
                        <span data-toggle="tab" data-target="#tab5-5"><i></i></span>
                    </li>
                </ul>

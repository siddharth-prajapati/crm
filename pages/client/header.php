            ...
            <div class="container-fluid menu-hidden">
                ...
                <div id="menu" class="hidden-print hidden-xs">
                    <div id="sidebar-fusion-wrapper">
                        ...
                        <ul class="menu list-unstyled" style="top:100px;">
                            <?php Menu::make($config["menu"]["client"], $page, $module, "collapse"); ?>
                       </ul>
                        </div>
                    </div>
                    <!-- // Sidebar Menu END -->
                        ...
                        <div class="navbar hidden-print main navbar-default" role="navigation">
                            ...
                            <ul class="main pull-right">
                                <li class="hidden-xs hidden-sm">
                                    <a href="" class="btn btn-primary" data-toggle="modal">Service Request</a>
                                </li>
